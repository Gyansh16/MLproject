import os
import sys
from mlproject.exception import CoustomException
...
from mlproject.components.model_trainer import ModelTrainerConfig
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('src/mlproject/notebook/data/stud.csv')
